...
document.write('<script>if (typeof goog != "undefined") { goog.require("goon_squad.core"); } else { console.warn("ClojureScript could not load :main, did you forget to specify :asset-path?"); };</script>');
