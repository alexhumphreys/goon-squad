...
var base_style__$1 = (cljs.core.truth_((function (){var and__18109__auto__ = selected_QMARK_;
...
var base_style__$2 = (cljs.core.truth_((function (){var and__18109__auto__ = selected_QMARK_;
if(cljs.core.truth_(and__18109__auto__)){
...
if(cljs.core.truth_((function (){var and__18109__auto__ = required_QMARK_;
if(cljs.core.truth_(and__18109__auto__)){
...
re_com.selection_list.list_container = (function re_com$selection_list$list_container(p__29357){
var map__29359 = p__29357;
var map__29359__$1 = ((cljs.core.seq_QMARK_.call(null,map__29359))?cljs.core.apply.call(null,cljs.core.hash_map,map__29359):map__29359);
var args = map__29359__$1;
var disabled_QMARK_ = cljs.core.get.call(null,map__29359__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.call(null,map__29359__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var item_renderer = cljs.core.get.call(null,map__29359__$1,new cljs.core.Keyword(null,"item-renderer","item-renderer",-743065410));
var model = cljs.core.get.call(null,map__29359__$1,new cljs.core.Keyword(null,"model","model",331153215));
var label_fn = cljs.core.get.call(null,map__29359__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263));
var required_QMARK_ = cljs.core.get.call(null,map__29359__$1,new cljs.core.Keyword(null,"required?","required?",-872514462));
var as_exclusions_QMARK_ = cljs.core.get.call(null,map__29359__$1,new cljs.core.Keyword(null,"as-exclusions?","as-exclusions?",-55596285));
var hide_border_QMARK_ = cljs.core.get.call(null,map__29359__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var choices = cljs.core.get.call(null,map__29359__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.call(null,map__29359__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798));
var multi_select_QMARK_ = cljs.core.get.call(null,map__29359__$1,new cljs.core.Keyword(null,"multi-select?","multi-select?",973156151));
...
var items = cljs.core.map.call(null,(cljs.core.truth_(item_renderer)?((function (selected,map__29359,map__29359__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__29354_SHARP_){
return item_renderer.call(null,p1__29354_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__29359,map__29359__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:(cljs.core.truth_(multi_select_QMARK_)?((function (selected,map__29359,map__29359__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__29355_SHARP_){
return re_com.selection_list.as_checked.call(null,p1__29355_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__29359,map__29359__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:((function (selected,map__29359,map__29359__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__29356_SHARP_){
return re_com.selection_list.as_radio.call(null,p1__29356_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__29359,map__29359__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
)),choices);
...
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(argseq__19161__auto__);
});

re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__29361){
...
var args = map__29362__$1;
if(cljs.core.truth_(((!(goog.DEBUG))?true:re_com.validate.validate_args.call(null,re_com.validate.extract_arg_data.call(null,re_com.selection_list.selection_list_args_desc),args,"selection-list")))){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol(null,"validate-args-macro","validate-args-macro",-1576181756,null),new cljs.core.Symbol(null,"selection-list-args-desc","selection-list-args-desc",-219283300,null),new cljs.core.Symbol(null,"args","args",-1338879193,null),"selection-list")))].join('')));
}

return ((function (map__29362,map__29362__$1,args){
return (function() { 
var G__29365__delegate = function (p__29363){
var map__29364 = p__29363;
var map__29364__$1 = ((cljs.core.seq_QMARK_.call(null,map__29364))?cljs.core.apply.call(null,cljs.core.hash_map,map__29364):map__29364);
var args__$1 = map__29364__$1;
...
var G__29365 = function (var_args){
var p__29363 = null;
if (arguments.length > 0) {
var G__29366__i = 0, G__29366__a = new Array(arguments.length -  0);
while (G__29366__i < G__29366__a.length) {G__29366__a[G__29366__i] = arguments[G__29366__i + 0]; ++G__29366__i;}
  p__29363 = new cljs.core.IndexedSeq(G__29366__a,0);
} 
return G__29365__delegate.call(this,p__29363);};
G__29365.cljs$lang$maxFixedArity = 0;
G__29365.cljs$lang$applyTo = (function (arglist__29367){
var p__29363 = cljs.core.seq(arglist__29367);
return G__29365__delegate(p__29363);
});
G__29365.cljs$core$IFn$_invoke$arity$variadic = G__29365__delegate;
return G__29365;
})()
;
;})(map__29362,map__29362__$1,args))
});

re_com.selection_list.selection_list.cljs$lang$maxFixedArity = (0);

re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq29360){
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq29360));
});

//# sourceMappingURL=selection_list.js.map?rel=1444936775175