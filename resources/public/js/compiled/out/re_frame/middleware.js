...
if(!((function (){var G__26316 = app_db;
if(G__26316){
...
return G__26316.reagent$ratom$IReactiveAtom$;
}
})())){
return true;
} else {
if((!G__26316.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_.call(null,reagent.ratom.IReactiveAtom,G__26316);
} else {
return false;
}
}
...
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__26322){
var args = cljs.core.seq(arglist__26322);
...
return cljs.core.get_in.call(null,new_db,p1__26323_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__26324_SHARP_){
return cljs.core.get_in.call(null,db,p1__26324_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
while (G__26325__i < G__26325__a.length) {G__26325__a[G__26325__i] = arguments[G__26325__i + 2]; ++G__26325__i;}
  in_paths = new cljs.core.IndexedSeq(G__26325__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__26326){
var f = cljs.core.first(arglist__26326);
arglist__26326 = cljs.core.next(arglist__26326);
var out_path = cljs.core.first(arglist__26326);
var in_paths = cljs.core.rest(arglist__26326);
...
//# sourceMappingURL=middleware.js.map?rel=1444936770284